...
import com.edu.ulab.app.exception.UserExistsException;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<BaseWebResponse> handleUserExistsExceptionException(@NonNull final UserExistsException exc) {
        log.error(exc.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new BaseWebResponse(createErrorMessage(exc)));
    }
